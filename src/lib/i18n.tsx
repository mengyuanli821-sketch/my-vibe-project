...
const ZH_TW: Record<string, string> = {
  "Overview": "總覽", "Guidance": "教學指引", "Today at a glance": "今日概覽", "Students": "學員", "Student directory": "學員名錄", "Profiles & history": "資料與紀錄", "Add student": "新增學員", "Create a profile": "建立資料", "Record class": "記錄課堂", "Post-class notes": "課後筆記", "Teaching": "教學", "Teacher Studio": "教師工作室", "Profile & coaching": "檔案與教練建議", "AI Class Planner": "AI 課程規劃", "Class Planner": "課程編排", "Open Class Planner": "開啟課程編排", "Build a timed sequence": "建立定時序列",
