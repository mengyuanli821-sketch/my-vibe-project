      ...
      <svg aria-hidden="true" className="h-11 w-11 shrink-0" viewBox="0 0 64 64">
        <defs>
          <linearGradient id="lotus-gradient" x1="8" x2="56" y1="8" y2="58" gradientUnits="userSpaceOnUse">
            <stop stopColor="#b88996" />
            <stop offset="1" stopColor="#6f5059" />
          </linearGradient>
        </defs>
        <circle cx="32" cy="32" fill="#eee1e4" r="30" />
        ...
        <path d="M18 48c8 4 20 4 28 0" fill="none" stroke="#6f5059" strokeLinecap="round" strokeWidth="3" />
        <circle cx="32" cy="31" fill="#b88996" r="2.5" />
      </svg>
      {!compact ? (
